...
ampy -p /dev/ttyUSB0 put adafruit_sgp30.mpy /adafruit_sgp30.mpy

echo "*** MOVING adafruit_bmp280.py ***"
ampy -p /dev/ttyUSB0 put adafruit_bmp280.mpy /adafruit_bmp280.mpy

echo "*** MOVING adafruit_bme280.py ***"
ampy -p /dev/ttyUSB0 put adafruit_bme280.mpy /adafruit_bme280.mpy

echo "*** MOVING adafruit_bme680.py ***"
ampy -p /dev/ttyUSB0 put adafruit_bme680.mpy /adafruit_bme680.mpy

echo "*** MOVING adafruit_htu21d.py ***"
ampy -p /dev/ttyUSB0 put adafruit_htu21d.mpy /adafruit_htu21d.mpy

echo "*** MOVING adafruit_veml6070-.py ***"
ampy -p /dev/ttyUSB0 put adafruit_veml6070.mpy /adafruit_veml6070.mpy

echo "*** MOVING adafruit_lsm303d.py ***"
ampy -p /dev/ttyUSB0 put adafruit_lsm303.mpy /adafruit_lsm303.mpy

echo "*** MOVING adafruit_mcp9808.py ***"
ampy -p /dev/ttyUSB0 put adafruit_mcp9808.mpy /adafruit_mcp9808.mpy
